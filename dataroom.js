 ...
 * }
 *
 * do not use a constructor function if you extend this class.
 *
 */
...
export default class DataroomElement extends HTMLElement {
  ...
  // Observes changes to the child elements in the DOM
  observeDomChanges() {
    this.log("observing DOM changes");
    this.domObserver = new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        if (mutation.type === "childList") {
          this.event("DOM-CHANGED", {
    ...
    this.domObserver.observe(this, config);
  }
